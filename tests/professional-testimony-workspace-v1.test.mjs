...
test("professional testimony surface retains editing, structural, review, audio, and export controls",()=>{
  for(const marker of ["Find / Replace","Replace selected","Low confidence","Unresolved participant honorifics","Next marked passage","Undo last edit or mark","Redo last edit or mark","Generate Word DOCX"])assert.ok(workspace.includes(marker),marker);
