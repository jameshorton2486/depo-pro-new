...
export async function transcribeWithDeepgram({ apiKey, filePath, keyterms = [], uploadId, operationId, fetchImpl=fetch, timeoutMs=Number(process.env.DEEPGRAM_TIMEOUT_MS)||2*60*60*1000 }) {
