...
def main():
    ...
    for page_index,page in enumerate(pages):
        ...
        for line_index,line in enumerate(page_lines):
            ...
            if len(line.get("text", ""))>profile["charactersPerLine"]:raise ValueError("Modeled line exceeds the profile width")
            run=paragraph.add_run(line["text"]);set_font(run,profile)
