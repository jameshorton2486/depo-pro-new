...
const record=createCanonicalDepositionRecord({jurisdictionType:"texas-state",court:"45TH JUDICIAL DISTRICT COURT, BEXAR COUNTY, TEXAS",causeNumber:"2026-CI-10001",caseStyle:"Alex Plaintiff v. Delta Company",witness:"Dr. Synthetic Witness",depositionDate:"2026-08-26",remote:false,location:"San Antonio, Texas",parties:[{name:"Alex Plaintiff",role:"Plaintiff"},{name:"Delta Company",role:"Defendant"}],attorneys:[{id:"counsel-bentley",name:"Dennis J. Bentley",honorific:"MR.",firm:"Plaintiff Firm",address:"100 Main, San Antonio, Texas",phone:"210-555-0101",represents:["Alex Plaintiff"],appearanceRole:"QUESTIONING_ATTORNEY",actualAppearance:true},{id:"counsel-ramon",name:"Christian R. Ramon",honorific:"MR.",firm:"Defense Firm",address:"200 Main, San Antonio, Texas",phone:"210-555-0102",represents:["Delta Company"],appearanceRole:"DEFENDING_ATTORNEY",actualAppearance:true}],reporterProfile:{name:"Riley Reporter",licenseNumber:"1234",csrExpiration:"2027-12-31",company:"Reporter Firm",firmRegistrationNumber:"5678",address:"300 Main, San Antonio, Texas",phone:"210-555-0103"}});
