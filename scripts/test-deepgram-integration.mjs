...
const apiKey=process.env.DEEPGRAM_API_KEY,fixture=process.env.DEPO_PRO_DEEPGRAM_TEST_AUDIO??process.env.DEEPOPRO_DEEPGRAM_TEST_AUDIO;
if(!apiKey||!fixture){console.error("Set DEEPGRAM_API_KEY and DEPO_PRO_DEEPGRAM_TEST_AUDIO to an approved disposable audio fixture.");process.exit(2)}
const filePath=fixture;if(!fs.existsSync(filePath))throw new Error("DEPO_PRO_DEEPGRAM_TEST_AUDIO does not exist.");
